...
//Modified by Alex Prucka, adjusted into a switchboard for
//testing multiple heap implementations
 ...
 * @param  heaptype: int 0 - 3 
//   0: first fit
//   1: best fit
//   2: worst fit
//   3: knuths buddy algo
// @param heapsize: size of the initialized heap in words
